...
\begin{document}
    ...
    \begin{Objective}{Successive Loop Closure}
        \begin{enumerate}[(a)]
            ...
            \[\Delta_{cl}^d = s^2 + 2 \zeta \omega_n s + \omega_n^2 = s^2 + 0.194425 s + 0.075625\]

            Equating with the closed loop characteristic polynomial we get:
            \[k_{D_h} = 0.194425 M_V \ \text{and} \ k_{P_h} = 0.075625 M_V\]
    ...
    \begin{Objective}{PID Control}
        ...
        \begin{enumerate}
            \item \texttt{/src/parameters.py}
            \item \texttt{/src/controller.py}
        \end{enumerate}
    \end{Objective}
    \pagebreak
