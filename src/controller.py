...
class PIDcontroller(Controller):
    ...
    def PIDupdate(self, z_r, h_r, q, qdot):
        ...
        self.integrator_z = self.integrate_error(e_z, self.error_prev_z, self.integrator_z)
        ...
        if self.ki_z > 0:
            ...
            self.integrator_z = self.anti_wind_up(self.integrator_z, Tau, Tau_sat, self.ki_z)  # To prevent integrator wind-up
